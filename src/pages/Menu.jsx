          ...
          >
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {group.items.map(it => (
                <div
                  key={it._id}
                  className="border border-orange-500  p-6 shadow-lg hover:shadow-orange-500/40 transition hover:-translate-y-1 bg-black"
                >
                  <div className="flex flex-col items-center text-center">
                    {it.imageUrl ? (
                      <img
                        src={it.imageUrl}
                        alt={it.name}
                        className="w-44 h-44 object-cover  mb-3 shadow-md hover:scale-105 transition"
                      />
                    ) : (
                      <div className="w-44 h-44 bg-gray-800  mb-3" />
                    )}
